 ...
 * 
 * Interactive demo of the expression builder interface
 * 
...
/**
 * Demo page component with interactive expression builder
 * 
        ...
        <div className="space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              Interactive demo - Build expressions and see live output
            </p>
          </div>
